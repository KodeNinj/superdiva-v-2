...
const Footer = () => {
	return (
		<footer className="min-h-[50vh] bg-[var(--primary-color)] ">
			<div className="text-[var(--white)] flex lg:flex-row flex-col lg:justify-between justify-center lg:items-start items-center py-[50px] px-[100px]">
				<div className="lg:w-[30%] w-full ">
					<div className="logo">
						...
						<p className="lg:text-[14px] md:text-[16px] text-sm my-[10px] lg:text-left text-center w-full">
